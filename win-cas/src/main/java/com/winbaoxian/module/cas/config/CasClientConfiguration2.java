...
public class CasClientConfiguration2 {
...
//        LogoutFilter logoutFilter = new LogoutFilter(casProperties.getCasServerUrlPrefix() + "/logout?service=" + casProperties.getServerName(), new SecurityContextLogoutHandler());
...
//    }
    ...
    public FilterRegistrationBean singleSignOutFilter() {
        ...
        filterRegistration.addInitParameter("casServerUrlPrefix", this.configProps.getServerUrlPrefix());
        filterRegistration.addInitParameter("serverName", this.configProps.getClientHostUrl());
    ...
    public FilterRegistrationBean cas30ProxyReceivingTicketValidationFilter() {
        ...
        cas30ProxyReceivingTicketValidationFilter.setServerName(this.configProps.getClientHostUrl());
